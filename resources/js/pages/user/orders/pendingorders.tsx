...
import { ordersdetails, pendingorders } from '@/routes/admin';
import { userorderdetails } from '@/routes';

const breadcrumbs: BreadcrumbItem[] = [
    {
        title: 'Pending Orders',
        href: pendingorders.url(), // Update with your actual route
    },
];
...
const PendingOrders = ({ orders }: IndexProps) => {
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                {orders.map((order) => (
                                    <tr key={order.id} className="hover:bg-gray-50">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <Link href={userorderdetails(order.transactionuuid)}>Click Here to view details</Link>
                                        </td>
