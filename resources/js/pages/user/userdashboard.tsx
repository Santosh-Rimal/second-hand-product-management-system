...
import { Package, ShoppingCart, CheckCircle, Clock, User, CreditCard } from 'lucide-react';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';

const breadcrumbs: BreadcrumbItem[] = [
    {
        title: 'Dashboard',
        href: userdashboard().url, // Fixed: Added parentheses
    },
];
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                ...
                <div className="mb-2">
                    ...
                    <p className="text-muted-foreground">
                        Welcome back, {auth.user?.name || 'User'}. Here's what's happening with your store today.
                    </p>
                </div>
