            ...
            <InfiniteScroll data="prooducts" buffer={500} preserveUrl>
                <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                    <div className="overflow-x-auto">
                        <Link href={UserProductController.create()} className="mb-4 inline-block rounded bg-blue-600 px-4 py-2 text-white hover:bg-blue-700">
                            Add New Product
                        </Link>
                                ...
                                {prooducts.data.map((product) => (
                                    <tr key={product.id} className="hover:bg-gray-50">
                                        ...
                                        <td className="border px-3 py-2">
                                            <Link href={UserProductController.show.url(product.id)}>{product.name}</Link>
                                        </td>
                                        ...
                                        <td className="border px-3 py-2">
                                            <div className="flex">
                                                <Link
                                                    href={UserProductController.edit.url(product.id)}
