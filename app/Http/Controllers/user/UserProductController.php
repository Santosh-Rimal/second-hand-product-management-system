...
class UserProductController extends Controller
{
    ...
    public function index()
    {
       ...
       return Inertia::render('user/products/index', [
        'prooducts' => Inertia::scroll(fn () => Product::with(['Category','seller'])->where('seller_id',Auth::id())->paginate(10))
       ]);
    }
    ...
    public function create()
    {
        ...
        return Inertia::render('user/products/products',['categories'=>$categories]); 
    }
